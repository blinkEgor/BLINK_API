...
void AOutputStub::cli_out( const std::string& message = "", text_color color = text_color::none, bg_color bg = bg_color::none ) override {
...
void AOutputStub::cli_endl() override {
	std::cout << std::endl;
}

bool AOutputStub::file_out( const std::string& message = "", const std::string& path = "", text_color color = text_color::none, bg_color bg = bg_color::none ) override {
